...
function listar() { // Función para listar todas las notas. 
    if(arrreglo.length===0){
        console.log("No hay estudinates registrados")
        return;
    }
    console.log("Lista de estudiantes");
    arrreglo.forEach(arrreglo=>{
        console.log(`-${arrreglo.titulo}: ${arrreglo.contenido}: ${arrreglo.nota}`)
    })
}
...
while(flag===true){ // Inicializacion de un ciclo, se ejecutara ya que va atado a la bandera declara inicialmente.
    ...
    console.log("4. Listar Notas Registradas")
    console.log("5.")
    console.log("6. Salir")
